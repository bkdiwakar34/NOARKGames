...
func _build_checklist_page() -> void:
	...
	_add_button(tools, "Validation recorder", _on_validation_recorder)
...
# ── Validation recorder (docs/validation_plan.md) ─────────────────────────────

func _on_validation_recorder() -> void:
	add_child(load("res://app/installer/validation_recorder.gd").new())
